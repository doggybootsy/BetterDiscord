...
export function useInternalStore<T>(stores: (Store | FluxStore) | Array<Store | FluxStore>, factory: () => T, deps?: React.DependencyList, areStateEqual: (oldState: T, newState: T) => boolean = (oldState, newState) => oldState === newState): T {
